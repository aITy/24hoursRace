...
public:
    ...
    void setupUi(QWidget *TimeBarWidget)
    {
        ...
        TimeBarWidget->setStyleSheet(QLatin1String("background: rgb(44, 44, 44);\n"
"border: none;"));
        ...
        label_H->setStyleSheet(QStringLiteral("color: rgb(180, 180, 180);"));
        ...
        label_M->setStyleSheet(QStringLiteral("color: rgb(180, 180, 180);"));
        ...
        label_S->setStyleSheet(QStringLiteral("color: rgb(180, 180, 180);"));
        label_S->setAlignment(Qt::AlignCenter);
        label_4 = new QLabel(TimeBarWidget);
        label_4->setObjectName(QStringLiteral("label_4"));
        label_4->setGeometry(QRect(70, 10, 10, 80));
        label_4->setFont(font1);
        label_4->setStyleSheet(QStringLiteral("color: rgb(180, 180, 180);"));
        ...
        label_5->setStyleSheet(QStringLiteral("color: rgb(180, 180, 180);"));
        ...
        font2.setWeight(75);
        label->setFont(font2);
        label->setStyleSheet(QStringLiteral("color: rgb(180, 180, 180);"));
