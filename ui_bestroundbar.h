...
public:
    ...
    void setupUi(QWidget *Form)
    {
        ...
        Form->resize(220, 130);
        Form->setStyleSheet(QStringLiteral("background: grey;"));
        ...
        label_M->setGeometry(QRect(9, 0, 71, 80));
        QFont font1;
        ...
        label_4->setGeometry(QRect(76, 0, 10, 80));
        ...
        label_Min->setGeometry(QRect(150, 3, 60, 80));
        QFont font2;
        ...
        label_Team->setStyleSheet(QStringLiteral("color: black"));
