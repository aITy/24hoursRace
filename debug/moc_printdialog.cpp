...
QT_MOC_LITERAL(3, 23, 13)
    ...
    "PrintDialog\0selection\0\0acceptRequest\0"
};
...
void PrintDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->selection((*reinterpret_cast< int(*)>(_a[1]))); break;
        ...
        {
            typedef void (PrintDialog::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&PrintDialog::selection)) {
                *result = 0;
            }
        }
    }
...
void *PrintDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Ui::PrintDialog"))
        return static_cast< Ui::PrintDialog*>(const_cast< PrintDialog*>(this));
...
// SIGNAL 0
void PrintDialog::selection(int _t1)
{
