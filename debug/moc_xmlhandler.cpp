...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_XmlHandler_t, stringdata) + ofs \
...
const QMetaObject XmlHandler::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_XmlHandler.data,
      qt_meta_data_XmlHandler,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_XmlHandler.stringdata))
        return static_cast<void*>(const_cast< XmlHandler*>(this));
