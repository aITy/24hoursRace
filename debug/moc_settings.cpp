...
QT_MOC_LITERAL(7, 71, 6)
    ...
    "Settings\0raceLengthChanged\0\0headlineChanged\0"
    "boardChanged\0accept\0reject\0update\0"
};
...
void Settings::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->raceLengthChanged(); break;
        case 1: _t->headlineChanged(); break;
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Settings::raceLengthChanged)) {
                *result = 0;
            }
        }
        {
            typedef void (Settings::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Settings::headlineChanged)) {
                *result = 1;
            }
        }
        {
            typedef void (Settings::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Settings::boardChanged)) {
                *result = 2;
            }
        }
    }
...
void *Settings::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Ui::Settings"))
        return static_cast< Ui::Settings*>(const_cast< Settings*>(this));
...
// SIGNAL 0
void Settings::raceLengthChanged()
{
    QMetaObject::activate(this, &staticMetaObject, 0, 0);
}

// SIGNAL 1
void Settings::headlineChanged()
{
    QMetaObject::activate(this, &staticMetaObject, 1, 0);
}

// SIGNAL 2
void Settings::boardChanged()
{
